// Auto-generated shim — re-exports from @/lib/hsk/config
// This lets shared ecosystem components import from "@/lib/act/config"
import type { ExamConfig as _hsk_Config } from "@/lib/hsk/config";
import { EXAM_CONFIG as _raw } from "@/lib/hsk/config";
