...
export const metadata: Metadata = {
  title: "Pricing — Hsk Premium",
  description: "Unlock unlimited Hsk practice with Koydo Premium.",
};

export default function PricingPage() {
  const checkoutUrl = `https://koydo.app/pricing?exam=hsk&cadence=annual`;
